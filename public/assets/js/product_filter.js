...
<!--    Listing Filter Script Starts-->// $("input[type='checkbox'], input[type='radio']").on( "click", productFilter() );
// $("select").on( "change", productFilter() );$(".city_check, .sub_cat_check ,.discount_check, .price_check").on( "click", productFilter );
$("select").on( "change", productFilter );function productFilter() {

    $(".all-product-total").css("opacity",0);    var mainarray = [];
    ...
    //To get Category values from All listing page ends    //To get Sub category values from All listing page starts
    ...
    var city_checklist = "&city_check="+city_check;    //To get Rating values from All listing page starts
    ...
    //To get Rating values from All listing page ends    var main_string = size_checklist+cat_checklist+sub_cat_checklist+discount_checklist+city_checklist+price_checklist;
    main_string = main_string.substring(1, main_string.length);    if(webpage_full_link != null){
