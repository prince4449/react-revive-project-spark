...
<!--    Listing Filter Script Starts-->// $("input[type='checkbox'], input[type='radio']").on( "click", listingFilter() );
// $("select").on( "change", listingFilter() );$(".city_check, .sub_cat_check ,.rating_check, .feature_check, .lfv2-all, .lfv2-pop, .lfv2-op, .lfv2-tru, .lfv2-near, .lfv2-off").on( "click", listingFilter );
$("select").on( "change", listingFilter );function listingFilter() {

    $(".all-listing-total").css("opacity",0);    var mainarray = [];
    ...
    //Top Filter Offer Option from All listing page ends    var main_string = size_checklist+cat_checklist+sub_cat_checklist+rating_checklist+city_checklist
